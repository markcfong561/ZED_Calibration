...
static void
StereoCalib(const vector<string>& imagelist, Size inputBoardSize, string type, float squareSize, float markerSize, bool displayCorners = false, bool useCalibrated=true, bool showRectified=true)
{
...
int main(int argc, char** argv)
{
    ...
    StereoCalib(imagelist, inputBoardSize, type, squareSize, markerSize, false, true, showRectified);
    return 0;
}